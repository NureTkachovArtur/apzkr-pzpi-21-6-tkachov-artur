...
namespace medireminder.Controllers
{
    ...
    public class AdministratorController : Controller
    {
        ...
        {
            var administrators = _mapper.Map<List<AdministratorGetDto>>(_administratorRepository.GetAdministrators());
        ...
        public IActionResult GetAdministrator(int adminId)
        {
            ...
            var administrator = _mapper.Map<AdministratorGetDto>(_administratorRepository.GetAdministrator(adminId));
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
        ...
        public IActionResult GetAdministratorByEmail(string email)
        {
            ...
            var administrator = _mapper.Map<AdministratorGetDto>
                (_administratorRepository.GetAdministratorByEmail(email));
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
        ...
        public IActionResult UpdateAdministrator(int adminId, [FromBody] AdministratorUpdateDto administratorUpdate)
        {
            ...
            account.UserName = administratorUpdate.UserName;
            account.LastName = administratorUpdate.LastName;
            account.FirstName = administratorUpdate.FirstName;
