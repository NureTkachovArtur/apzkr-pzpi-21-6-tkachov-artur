...
namespace medireminder.Migrations
{
    ...
    public partial class InitMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SmartDeviceTypes",
                columns: table => new
                {
                    SmartDeviceTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmartDeviceTypes", x => x.SmartDeviceTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TrusteeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trustees_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SmartDevices_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SmartDevices_SmartDeviceTypes_SmartDeviceTypeId",
                        column: x => x.SmartDeviceTypeId,
                        principalTable: "SmartDeviceTypes",
                        principalColumn: "SmartDeviceTypeId",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "PatientTrustees",
                columns: table => new
                {
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    TrusteeId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientTrustees", x => new { x.PatientId, x.TrusteeId });
                    table.ForeignKey(
                        name: "FK_PatientTrustees_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientTrustees_Trustees_TrusteeId",
                        column: x => x.TrusteeId,
                        principalTable: "Trustees",
                        principalColumn: "TrusteeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmartDeviceId = table.Column<int>(type: "int", nullable: false),
                    MedicineId = table.Column<int>(type: "int", nullable: false),
                    MedicationStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DosesPerDay = table.Column<float>(type: "real", nullable: false),
                    EveryNDay = table.Column<int>(type: "int", nullable: false),
                    DaysLeft = table.Column<int>(type: "int", nullable: false),
                    MedicationIntervalMinutes = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicationSchedules_SmartDevices_SmartDeviceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScheduleEventId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MedicationScheduleId = table.Column<int>(type: "int", nullable: false),
                    MissedDose = table.Column<bool>(type: "bit", nullable: false),
                    MedicationTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleEvents", x => x.ScheduleEventId);
                    table.ForeignKey(
                        name: "FK_ScheduleEvents_MedicationSchedules_MedicationScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicationSchedules_SmartDeviceId",
                table: "MedicationSchedules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientTrustees_TrusteeId",
                table: "PatientTrustees",
                column: "TrusteeId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleEvents_MedicationScheduleId",
                table: "ScheduleEvents",
                column: "MedicationScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_SmartDevices_PatientId",
                table: "SmartDevices",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_SmartDevices_SmartDeviceTypeId",
                table: "SmartDevices",
                column: "SmartDeviceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Trustees_ApplicationUserId",
                table: "Trustees",
                column: "ApplicationUserId");
        }
